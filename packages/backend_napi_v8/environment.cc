...
struct inherited_classes {
		js::forward<napi::local_of<function_tag>> agent;
		js::forward<napi::local_of<function_tag>> module_;
...
auto environment::make_initialize() -> napi::local_of<function_tag> {
	...
	return napi::local_of<function_tag>::make(*this, js::free_function{initialize});
}
