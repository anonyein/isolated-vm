...
export constexpr auto make_type_pack = util::overloaded{
	...
	[]<class... Types>(type_pack_of<Types...> pack) constexpr -> auto { return pack; },
	[]<template <class...> class Pack, class... Types>(std::type_identity<Pack<Types...>> /*type*/) constexpr -> auto {
...
constexpr auto spread_type_pack = util::overloaded{
	[]<class... Hidden>(type_pack_of<Hidden...> /*pack*/) constexpr -> auto { return type<Into<typename Hidden::type...>>; },
	[]<template <class...> class Pack, class... Types>(std::type_identity<Pack<Types...>> /*type*/) constexpr -> auto {
...
export constexpr auto pack_concat = util::overloaded{
	[]() constexpr -> auto { return type_pack{}; },
	[](auto&&... packs) constexpr -> auto { return (... + make_type_pack(packs)); },
};

// Apply transformation function to each type in the pack
export constexpr auto pack_transform = [](auto pack, auto unary) constexpr -> auto {
...
export constexpr auto pack_filter = [](auto pack, auto predicate) constexpr -> auto {
...
export constexpr auto pack_partition = util::overloaded{
	[](auto pack) constexpr -> auto { return type_pack{pack}; },
	[]<class Predicate>(this auto pack_partition, auto pack, Predicate predicate, auto... predicates) constexpr -> auto {
